...
<div className="flex justify-between items-center">
  {/* History Title */}
  <h2 className="text-4xl font-bold font-Parkinsans text-black">
    History
  </h2>
...
<div className="grid grid-cols-2 sm:grid-cols-4 gap-2 mb-44 mt-16">
  {historyQuizzes.map((quiz) => {
    ...
    return (
      <div
        key={quiz.id}
        className="group bg-white rounded-lg text-center h-72 w-56 mx-auto transition-all"
      >
   {/* Progress Bar with Clickable Heart Icon */}
              <div className="flex items-center space-x-2 mb-3 px-4">
               <button
                ...
                <AiFillHeart
                   className="w-4 h-4"
                   style={{ color: isFavorite ? "pink" : "white" }} // Pink heart when favorite
                        />
                </button>
...
<div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-16">
  {scienceQuizzes.map((quiz) => {
    ...
    return (
      ...
      <p className="text-center mt-48 text-black font-medium text-5xl">
